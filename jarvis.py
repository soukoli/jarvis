...
class JarvisApp(rumps.App):
    ...
    def show_about(self, _=None):
        ...
        rumps.alert(
            ...
            message=(
                "🎤 Version 2.1\n\n"
                "Local voice-to-text transcription for macOS.\n"
                "Private, fast, and works everywhere.\n\n"
                "═══════════════════════════════\n\n"
                "Quick Start:\n\n"
                f"  {self.hotkey_start}   Start recording\n"
                f"  {self.hotkey_stop}   Stop & transcribe\n"
                f"  {self.hotkey_cancel}   Cancel anytime\n\n"
                "═══════════════════════════════\n\n"
                "How it works:\n\n"
                "1️⃣  Press Cmd+; to start\n"
                "2️⃣  Speak clearly\n"
                "3️⃣  Press Cmd+' when done\n"
                "4️⃣  Wait for 'ding' sound\n"
                "5️⃣  Press Cmd+V to paste\n\n"
                "═══════════════════════════════\n\n"
                "💡 Tips:\n\n"
                "• Watch the menu bar icon:\n"
                "  🎤 = Ready  🔴 = Recording  🧠 = Processing\n\n"
                "• Language flag shows your setting\n"
